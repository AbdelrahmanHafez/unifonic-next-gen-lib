...
environmentsMap[environments.PRODUCTION][servers.BASE_URL] = 'https://el.cloud.unifonic.com';
...
const Configuration = {
     ...
     */
    getBaseUri(server) {
        const url = environmentsMap[this.currentEnvironment][server || servers.BASE_URL];
        const urlParams = {
        };
